      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildStatItem(Icons.timelapse_outlined, 'Recent Verifications', '128', Colors.green),
            const SizedBox(height: 20),
            _buildStatItem(Icons.warning_amber_rounded, 'Alerts: Forged Attempts', '3', Colors.red),
          ],
        ),
      ),
    );
